...
public class BookSearch extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,BaseQuickAdapter.RequestLoadMoreListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnLoadMoreListener(new BookSearch(),ry);
        ...
        Runnable runnable = new Runnable(){
            ...
            public void run() {
                ...
                bList.addAll(BookApi.getListbySearch(BookBaseInfo.searchtext,0));
    ...
    private static final class Listndler extends Handler {
        WeakReference<BookSearch> mMainActivityWeakReference;

        public Listndler(BookSearch mainActivity) {
    ...
    final static BookSearch.Listndler handler=new BookSearch.Listndler(new BookSearch());

    private static final class Listndler2 extends Handler {
        WeakReference<BookSearch> mMainActivityWeakReference;

        public Listndler2(BookSearch mainActivity) {
            mMainActivityWeakReference = new WeakReference<>(mainActivity);
        }
    ...
    final static BookSearch.Listndler2 handler2=new BookSearch.Listndler2(new BookSearch());
    ...
    public void onLoadMoreRequested() {
        ...
        Runnable runnable = new Runnable(){
            ...
            public void run() {
                ...
                page++;
                Message msg = new Message();
                bList.addAll(BookApi.getListbySearch(BookBaseInfo.searchtext,page));
