...
public class GetIMDB extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,BaseQuickAdapter.RequestLoadMoreListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnLoadMoreListener(new GetIMDB(),ry);
        ...
        Runnable runnable = new Runnable(){
            ...
            public void run() {
                ...
                bList.addAll(MovieApi.getListbyIMDB(1));
    ...
    private static final class Listndler extends Handler {
        WeakReference<GetIMDB> mMainActivityWeakReference;

        public Listndler(GetIMDB mainActivity) {
    ...
    final static GetIMDB.Listndler handler=new GetIMDB.Listndler(new GetIMDB());

    private static final class Listndler2 extends Handler {
        WeakReference<GetIMDB> mMainActivityWeakReference;

        public Listndler2(GetIMDB mainActivity) {
            mMainActivityWeakReference = new WeakReference<>(mainActivity);
        }
    ...
    final static GetIMDB.Listndler2 handler2=new GetIMDB.Listndler2(new GetIMDB());
    ...
    public void onLoadMoreRequested() {
        ...
        Runnable runnable = new Runnable(){
            ...
            public void run() {
                ...
                page++;
                Message msg = new Message();
                bList.addAll(MovieApi.getListbyIMDB(page));
