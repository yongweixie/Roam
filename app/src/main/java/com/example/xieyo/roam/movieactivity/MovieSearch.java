...
public class MovieSearch extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,BaseQuickAdapter.RequestLoadMoreListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnLoadMoreListener(new MovieSearch(),ry);
        ...
        Runnable runnable = new Runnable(){
            ...
            public void run() {
                ...
                bList.addAll(MovieApi.getListbySearch(MovieBaseInfo.searchtext,0));
    ...
    private static final class Listndler extends Handler {
        WeakReference<MovieSearch> mMainActivityWeakReference;

        public Listndler(MovieSearch mainActivity) {
    ...
    final static MovieSearch.Listndler handler=new MovieSearch.Listndler(new MovieSearch());

    private static final class Listndler2 extends Handler {
        WeakReference<MovieSearch> mMainActivityWeakReference;

        public Listndler2(MovieSearch mainActivity) {
            mMainActivityWeakReference = new WeakReference<>(mainActivity);
        }
    ...
    final static MovieSearch.Listndler2 handler2=new MovieSearch.Listndler2(new MovieSearch());
    ...
    public void onLoadMoreRequested() {
        ...
        Runnable runnable = new Runnable(){
            ...
            public void run() {
                ...
                page++;
                Message msg = new Message();
                bList.addAll(MovieApi.getListbySearch(MovieBaseInfo.searchtext,page));
